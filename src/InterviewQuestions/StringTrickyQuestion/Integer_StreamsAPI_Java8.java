...
public class Integer_StreamsAPI_Java8 {
    ...
    public static void main(String[] args) {
        ...
        /**
         *  2nd heighest element from array
         */

        Optional<Integer> secondHeighestElement = intList.stream()
                .distinct()
                .sorted(Comparator.reverseOrder())
                .skip(1)
                .findFirst();
        System.out.println("secondHeighestElement: " + secondHeighestElement);

        /**
         * K th Smallest number in an array
         */
            int k = 3;
        Optional<Integer> smallestNumber3rd = intList.stream()
                        .distinct()
                        .sorted()
        ...
        System.out.println("smallestNumber3rd :"+smallestNumber3rd);

        /**
         *  count the occurance of each element
         */

        Map<Integer,Long> occurance = intList.stream()
                .collect(Collectors.groupingBy(c->c,TreeMap::new,Collectors.counting()));

        System.out.println("Count the occurance of each element in the array :"+occurance);
